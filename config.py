...
WEIGHT_SPECIFICITY: float = _get_float("WEIGHT_SPECIFICITY", 0.35)
...
EWMA_BEHAVIORAL_TRACK_SCALE: float = _get_float("EWMA_BEHAVIORAL_TRACK_SCALE", 0.45)
...
SESSION_SOURCING_MIN_STRONG_WINDOWS: int = max(
    1, int(_get_float("SESSION_SOURCING_MIN_STRONG_WINDOWS", 2))
)

# Contrastive cold start (empty NATURAL profile at interview start)
COLD_START_SUSPICION_TIER_BOOST: float = _get_float("COLD_START_SUSPICION_TIER_BOOST", 0.10)
COLD_START_WEAK_SCRIPT_CEILING: float = _get_float("COLD_START_WEAK_SCRIPT_CEILING", 0.62)
COLD_START_PROBABLE_MIN_STRONG_WINDOWS: int = max(
    2, int(_get_float("COLD_START_PROBABLE_MIN_STRONG_WINDOWS", 4))
)

# Intra-individual behavioral modeling (person-relative baseline)
ENABLE_INTRA_INDIVIDUAL: bool = _get_bool("ENABLE_INTRA_INDIVIDUAL", True)
INTRA_INDIVIDUAL_AUTHORITY: bool = _get_bool("INTRA_INDIVIDUAL_AUTHORITY", False)
INTRA_INDIVIDUAL_PRESERVE_UNCERTAINTY: bool = _get_bool("INTRA_INDIVIDUAL_PRESERVE_UNCERTAINTY", True)
INTRA_INDIVIDUAL_SESSION_REFINEMENT: bool = _get_bool("INTRA_INDIVIDUAL_SESSION_REFINEMENT", True)
PERSONAL_BASELINE_EARLY_ANSWERS: int = max(1, int(_get_float("PERSONAL_BASELINE_EARLY_ANSWERS", 2)))
PERSONAL_BASELINE_UPDATE_ALPHA: float = _get_float("PERSONAL_BASELINE_UPDATE_ALPHA", 0.08)
PERSONAL_BASELINE_BOOTSTRAP_ALPHA: float = _get_float("PERSONAL_BASELINE_BOOTSTRAP_ALPHA", 0.22)
PERSONAL_BASELINE_MAD_FLOOR: float = _get_float("PERSONAL_BASELINE_MAD_FLOOR", 0.05)
PERSONAL_DEVIATION_Z_CAP: float = _get_float("PERSONAL_DEVIATION_Z_CAP", 2.5)
SESSION_P_PRIOR: float = _get_float("SESSION_P_PRIOR", 0.5)
SESSION_P_AMBIGUOUS_LOW: float = _get_float("SESSION_P_AMBIGUOUS_LOW", 0.42)
SESSION_P_AMBIGUOUS_HIGH: float = _get_float("SESSION_P_AMBIGUOUS_HIGH", 0.58)
SESSION_P_PROBABLE_MIN: float = _get_float("SESSION_P_PROBABLE_MIN", 0.62)
...
SPECIFICITY_GENERIC_PROBABLE_MIN: float = _get_float("SPECIFICITY_GENERIC_PROBABLE_MIN", 0.58)
MEMORIZED_TECHNICAL_PROBABLE_MIN: float = _get_float("MEMORIZED_TECHNICAL_PROBABLE_MIN", 0.42)
PERSONAL_NARRATIVE_CLEAR_MIN: float = _get_float("PERSONAL_NARRATIVE_CLEAR_MIN", 0.35)
CONTENT_DIVERSITY_MIN_ANSWERS: int = max(2, int(_get_float("CONTENT_DIVERSITY_MIN_ANSWERS", 3)))
CONTENT_UNIFORMITY_SUSPICIOUS_MIN: float = _get_float("CONTENT_UNIFORMITY_SUSPICIOUS_MIN", 0.52)
SESSION_FEEDFORWARD_MIN_ANSWERS: int = max(1, int(_get_float("SESSION_FEEDFORWARD_MIN_ANSWERS", 2)))
SESSION_FEEDFORWARD_P_MIN: float = _get_float("SESSION_FEEDFORWARD_P_MIN", 0.55)
SESSION_FEEDFORWARD_UPDATE_STRENGTH: float = _get_float("SESSION_FEEDFORWARD_UPDATE_STRENGTH", 0.38)
MIN_CALIBRATION_WINDOWS: int = max(1, int(_get_float("MIN_CALIBRATION_WINDOWS", 5)))
MIN_SCRIPT_PROFILE_SAMPLES: int = max(1, int(_get_float("MIN_SCRIPT_PROFILE_SAMPLES", 3)))
CALIBRATION_FAIL_SOFT: bool = _get_bool("CALIBRATION_FAIL_SOFT", False)
